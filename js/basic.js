...
if(!localStorage.getItem("diagramControl")) localStorage.setItem("diagramControl", JSON.stringify([
    {
        type        : 'monthly-diagram',
        main        : true,
        furniture   : true,
        accessories : true,
        fpQty       : true,
...
let color = {
    ...
    unloading           : 'darkblue',
    ready               : 'blue',
    customerDelivery    : 'red',
    storeDelivery       : 'lightred',
    pickUp              : 'darkred',
    instal              : 'yellow',
    comser              : 'orange',
    late                : 'grey',
